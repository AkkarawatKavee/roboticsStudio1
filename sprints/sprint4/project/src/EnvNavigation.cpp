...
public:
    EnvNavigation() : Node("EnvNavigation")
    {
        ...
        // Execute the navigation to waypoints
        SendGoal(goal_poses);
    }
...
private:
    ...
    void personLocation(const geometry_msgs::msg::PoseStamped &injured)
    {
        ...
        injured_person.pose.position.x = injured_person.pose.position.x - 0.5;
        injured_person.pose.position.y = injured_person.pose.position.y - 0.5;
